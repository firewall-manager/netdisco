...
__PACKAGE__->add_columns(
  ...
  "module", {data_type => "integer", is_nullable => 1}, "admin", {data_type => "text", is_nullable => 1},
  "status", {data_type => "text",    is_nullable => 1}, "class", {data_type => "text", is_nullable => 1},
  "power",  {data_type => "integer", is_nullable => 1},
);
...
__PACKAGE__->belongs_to(
  device_module => 'App::Netdisco::DB::Result::DevicePower',
